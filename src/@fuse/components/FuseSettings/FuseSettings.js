            ...
            <div className={classes.root}>
                ...
                <div className={classNames(classes.formGroup, "pb-16")}>
                    ...
                    <FormControl component="fieldset" className={classes.formControl}>
                        ...
                        <ThemeSelect value={settings.theme.navbar} name="theme.navbar"
                                     handleChange={this.handleChange}/>
                    </FormControl>
                    <FormControl component="fieldset" className={classes.formControl}>
                        <FormLabel component="legend" className="text-14">Toolbar</FormLabel>
                        <ThemeSelect value={settings.theme.toolbar} name="theme.toolbar"
                                     handleChange={this.handleChange}/>
                    </FormControl>
                    <FormControl component="fieldset" className={classes.formControl}>
                        <FormLabel component="legend" className="text-14">Footer</FormLabel>
                        <ThemeSelect value={settings.theme.footer} name="theme.footer"
                                     handleChange={this.handleChange}/>
                    </FormControl>
                </div>
